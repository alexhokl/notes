  ...
  * [Language](#language)
    ...
    + [Array, slice, reference and range](#array%2C-slice%2C-reference-and-range)
...
[Cross-site request forgery (CSRF) protection - Modern approach (2023)](./go.md#modern-approach-2023)
...
func main() {
	...
	csrfProtection.AddTrustedOrigin("https://client.example.com")

	// exclude the OAuth endpoint from CSRF protection
...
- note that `AddTrustedOrigin` does not accept wildcards

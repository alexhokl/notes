  ...
  * [Troubleshooting](#troubleshooting)
    + [error "unable to fetch certificate that owns the secret"](#error-%22unable-to-fetch-certificate-that-owns-the-secret%22)
  * [Commands](#commands)
...
- [kro - Powerful Abstractions for Kubernetes](https://kro.run/) - allow a
  simpler way to define Kubernetes resources

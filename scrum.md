...
- it can be changed and refined at anytime except the moment before sprint planning

### Splitting a story

- Stories which will not be worked on in the upcoming 1-3 sprints can be big
- if a story which will not be worked on in the coming 6 months, it is usually called "epic" and it is meant to be splitted at a later time.
- for a bigger story, it can be splitted into smaller stories based on use cases

### Ordering

- items with higher risk should have a higher priority (so that we know earlier whether it would work or not)
...
- servant leader (taking the shits, and/or suggesting new technologies or methodologies)
...
- big picture and rolling release planning (it could mean breaking down future stories which will not be worked on the current sprint)
...
- documentation (user documentation, design documentation release notes,API documentation)
...
- includes only development team
- not a status report
...
- safety (make sure team members feel comfortable to say things, so product owner  is optional)

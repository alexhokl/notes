...
- IEEE 754-2008 Double Format
- using a few bits in a 4- or 6-byte data to indicate the type of data
...
- `monotonic_buffer_resource` for short-lived C++ objects that allocate and
    dellocate, often you prefer to defer deallocation
  - it allocates sqquenctially from a single bugger just by moving a pointer
      within a range of bytes
- checkout `std::pmr::string`
- 
